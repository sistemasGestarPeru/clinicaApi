...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('contratoProducto/consultarHistorialContrato/{contrato}', [ContratoProductoeController::class, 'consultarHistorialContrato']);
    ...
    Route::get('producto/existePrecioTemporal/{sede}/{producto}', [ProductoController::class, 'existePrecioTemporal']);
    Route::get('producto/comboIGV/{producto}/{sede}', [ProductoController::class, 'comboIGV']);
    ...
    Route::post('sedeDocVenta/actualizarSedeDocVenta', [LocalDocumentoVentaController::class, 'actualizarSedeDocVenta']);
    Route::get('sedeDocVenta/listarDocumentosReferencia/{sede}/{consultaDoc}', [LocalDocumentoVentaController::class, 'listarDocumentosReferencia']);
    ...
    Route::get('seguridad/consultarPerfil/{codigo}/{app}', [UserController::class, 'consultarPerfil']);

    //ROLES
    Route::post('rol/registroRol', [RolController::class, 'registroRol']);
    Route::post('rol/actualizarRol', [RolController::class, 'actualizarRol']);
    Route::get('rol/listarRoles/{app}', [RolController::class, 'listarRoles']);
    Route::get('rol/consultarRol/{codigo}', [RolController::class, 'consultarRol']);
    Route::get('rol/listarRolesVigentes/{app}', [RolController::class, 'listarRolesVigentes']);
    ...
    //REPORTES 
    Route::get('reportes/listarProveedoresPendientes/{sede}', [ReportesController::class, 'listarProveedoresPendientes']);
    Route::get('reportes/listarProveedorPagos/{sede}', [ReportesController::class, 'listarProveedorPagos']);
    ...
    Route::post('reportes/reportePagosProveedores', [ReportesController::class, 'reportePagosProveedores']);
    Route::post('reportes/reportePagosPendientesProveedores', [ReportesController::class, 'reportePagosPendientesProveedores']);
    ...
    Route::post('reportes/reporteCompraServicios', [ReportesController::class, 'reporteCompraServicios']);
    Route::post('reportes/reporteIngresosServicios', [ReportesController::class, 'reporteIngresosServicios']);
    Route::post('reportes/reporteDocumentoServicio', [ReportesController::class, 'reporteDocumentoServicio']);
